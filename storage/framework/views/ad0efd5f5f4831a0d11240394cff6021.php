               ...
               <div class="row">
                  ...
                  <div class="col-md-6 how_card">
                     ...
                     <div class="price_main">
                        ...
                        <div class="read_btn"><a href="<?php echo e(url('/parkings')); ?>">See Details<span class="arrow_icon"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></a></div>
                     </div>
                  </div>
               </div>
            </div>
            ...
            <div class="blog_section_2">
               <div class="row">
                  <div class="col-md-4">
                     ...
                     <div class="btn_main">
                        <div class="date_text"><a href="<?php echo e(url('/parkings')); ?>">Availability: Live</a></div>
                     </div>
                     <div class="blog_box">
                     ...
                     <div class="read_bt"><a href="<?php echo e(url('/parkings')); ?>">View Area<span class="arrow_icon"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></a></div>
                  </div>
                  <div class="col-md-4">
                     <div class="blog_img"><img src="<?php echo e(asset('landing/images/img-5.png')); ?>"></div>
                     <div class="btn_main">
                        <div class="date_text active"><a href="<?php echo e(url('/parkings')); ?>">Availability: High</a></div>
                     </div>
                     <div class="blog_box">
                     ...
                     <div class="read_bt active"><a href="<?php echo e(url('/parkings')); ?>">View Area<span class="arrow_icon"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span></a></div>
                  </div>
                  <div class="col-md-4">
                     <div class="blog_img"><img src="<?php echo e(asset('landing/images/img-6.png')); ?>"></div>
                     <div class="btn_main">
                        <div class="date_text"><a href="<?php echo e(url('/parkings')); ?>">Availability: Limited</a></div>
                     </div>
                     <div class="blog_box">
