...
<div class="admin-page">
    ...
    <div class="card admin-card" style="max-width: 600px; margin: 0 auto; background: white; border-radius: 12px; box-shadow: 0 6px 15px rgba(0,0,0,0.1); padding: 30px;">
        <form method="POST" action="<?php echo e($isOwner ? route('owner.parkings.store') : route('admin.parkings.store')); ?>">
            <?php echo csrf_field(); ?>
            ...
            <div class="form-group mb-4">
                ...
                <input type="number" id="total_spots" name="total_spots" min="1" required
                       style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1rem;">
            </div>

            <div class="form-group mb-4">
                <label for="available_spots" style="display: block; margin-bottom: 8px; font-weight: 600; color: #333;">Available Spots</label>
                <input type="number" id="available_spots" name="available_spots" min="0" required
                       style="width: 100%; padding: 10px 12px; border: 1px solid #ddd; border-radius: 8px; font-size: 1rem;">
            </div>
            ...
            <div class="form-group mb-4">
                <label for="image_url" style="display: block; margin-bottom: 8px; font-weight: 600; color: #333;">
                    Image URL
                </label>
                <input type="url"
                       id="image_url"
