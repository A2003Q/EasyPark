   ...
   <body data-spy="scroll" data-target="#navbarSupportedContent" data-offset="90">
         ...
         <div class="container">
            <div class="row justify-content-center text-center">
               <div class="col-lg-3 col-sm-6">
                  <h1 class="rated_text"><span class="padding_10"><img src="{{ asset('landing/images/icon-1.png') }}"></span><span class="countup" data-target="3700">0</span></h1>
                  <p class="house_text">Active Users</p>
               </div>
               <div class="col-lg-3 col-sm-6">
                  <h1 class="rated_text"><span class="padding_10"><img src="{{ asset('landing/images/icon-2.png') }}"></span><span class="countup" data-target="5700">0</span></h1>
      ...
      <div class="choose_section_2">
         <div class="container">
            <div class="row justify-content-center text-center">
               <div class="col-lg-3 col-sm-6">
                  <h1 class="rated_text"><span class="padding_10"><img src="{{ asset('landing/images/icon-3.png') }}"></span><span class="countup" data-target="124">0</span></h1>
                  <p class="house_text">Parking Areas</p>
               </div>
               <div class="col-lg-3 col-sm-6">
                  <h1 class="rated_text"><span class="padding_10"><img src="{{ asset('landing/images/icon-4.png') }}"></span><span class="countup" data-target="704">0</span></h1>
