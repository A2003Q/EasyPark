...
<div class="container user-page-wrap">
  ...
  <div class="pe-searchbar mb-4">
    <form method="GET" action="<?php echo e(route('user.parkings.index')); ?>" class="row g-3 align-items-end">
      <div class="col-md-4">
      ...
      <div class="col-md-5">
        ...
        <input type="text" class="form-control" name="place" value="<?php echo e($place); ?>" placeholder="e.g. Downtown, Abdoun, City Mall...">
      </div>
      ...
      <?php if($parkings->count() > 0): ?>
        <div class="results-counter">
          ...
          <div class="results-counter-text">
            Found <span class="results-counter-number"><?php echo e($parkings->total()); ?></span> parking spot<?php echo e($parkings->total() > 1 ? 's' : ''); ?>
              ...
              <div class="card-content">
                <div class="d-flex justify-content-between align-items-start mb-2">
                  ...
                  <span class="pe-pill <?php echo e($p->available_spots > 0 ? 'pe-pill-ava' : 'pe-pill-busy'); ?>">
                    ...
                    <?php echo e($p->available_spots > 0 ? 'Available' : 'Full'); ?>
                ...
                <div class="spots-info">
                  ...
                  <div class="spots-info-text">
                    ...
                    <div class="spots-info-value"><?php echo e($p->available_spots); ?></div>
                  </div>
                </div>

                <div class="card-actions">
                  <a class="btn pe-btn-outline" href="<?php echo e(route('user.parkings.show', $p->id)); ?>">
                    <i class="fas fa-info-circle"></i> Details
                  </a>
                  <button class="btn-map" type="button" onclick="focusMarker(<?php echo e($p->id); ?>)">
